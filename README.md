...
- **Tələbə:** tapşırıqlara baxır (ümumi + özünə təyin olunan xüsusi task'lar; deadline keçmiş təhvilsiz task gizlənir), hər task'a bir dəfə fayl (max 100 MB, DB'de saklanır) ilə təhvil verir, şifrəsini dəyişir, qiymətini ve rəyini görür.

Tapşırıq yaradarkən icazəli fayl tipleri ve təyinli tələbələr aramalı siyahıdan seçilir (boş = hamıya); `.exe` türevleri her durumda yasaktır. Son tarix keçmişdə ola bilməz; dərsdə bitiş başlanğıcdan sonra olmalıdır. Son tarix keçən task'a təhvil bağlanır. Siyahılar 200 kayıtla sınırlıdır. Qiymət verilən təhvilin dosya içeriği DB'den otomatik silinir (yer açılır). Dashboard sayaçları role göredir (tələbə öz kapsamını görür). `/robots.txt` arama motorlarına kapalıdır. İdarəetmə cədvəlində tələbə ad-soyadı görünür; Hamısı/Gözləyən/Baxılan filtri ve axtarış vardır. Qiymətləndirilməmiş təhvili olan tapşırıq silinemez (əvvəlcə hamısını qiymətləndir — qiymət 0-10 məcburidir, qiymətsiz `Qəbul` yoxdur); hamısı qiymətləndirilibsə silinəndə təhvillər də silinir. İstifadəçi silinəndə task/təhvil/dərsləri ilə birlikdə silinir (öz hesabı bloklanır). Arxivlənən taskın qiymət+rəyi tələbədə `Arxiv və bitmiş qiymətlərim` yerində qalır. Deadline keçmiş təhvilsiz task tələbədən gizlənir (staff görməyə davam edir).
